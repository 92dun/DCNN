...
def get_args_parser():
    ...
    # * Mixup params
    parser.add_argument('--mix_loss', type=bool, default=False,
                        help='mix loss')
    ...
    parser.add_argument('--data-path', default='/datasets01_101/imagenet_full_size/061417/', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='IMNET', choices=['IMNET', 'OxfordFlowers', 'Food101', 'CUB_200_2011', 'StanfordDogs'],
    ...
    parser.add_argument('--local-rank', default=-1, help='local rank')
...
def main(args):
    ...
    if args.mix_loss:
        from centorloss import MixLoss
        criterion = MixLoss(num_classes=args.nb_classes, conv_feat_dim=512, trans_feat_dim=576)
    elif args.mixup > 0.:
    ...
    ##### Statistical parameters and macs #####
